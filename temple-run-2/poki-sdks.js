(() => {
  ...
  const e = e => {
    ...
    a = navigator.userAgent.includes("PokiCar"),
    r = t || a;
  const s = new class {
    #
    e = [];
  ...
  if (window.PokiSDK = {
    ...
    window.PokiSDK.measure = (d, c, l) => {
      if (d = `${d}`, c = void 0 === c ? "" : `${c}`, l = void 0 === l ? "" : `${l}`, window.pokiMeasureBuildin = !0, "funnel" === d) {
  ...
  if (!r) {
    const t = (() => {
        const t = window.pokiSDKVersion || e("ab") || "77c04a3b1d76eb2abf3181cf138befb11f57d2d9";
        let n = `poki-sdk-core-${t}.js`;
        return o && (n = `poki-sdk-playground-${t}.js`), i && (n = `poki-sdk-hoist-${t}.js`), `https://game-cdn.poki.com/scripts/${t}/${n}`
      })(),
      n = document.createElement("script");
    n.setAttribute("src", t), n.setAttribute("type", "text/javascript"), n.setAttribute("crossOrigin", "anonymous"), n.onload = () => s.dequeue(), document.head.appendChild(n)
  }
})();
(() => {
  "use strict";
  ...
  if (!r) {
    const t = (() => {
        const t = window.pokiSDKVersion || e("ab") || "77c04a3b1d76eb2abfp3181cf138befb11f57d2d9";
        let n = `poki-sdk-core-${t}.js`;
        return o && (n = `poki-sdk-playground-${t}.js`), i && (n = `poki-sdk-hoist-${t}.js`), `https://game-cdn.poki.com/gaesmdifpgrjjosikoFiuyltrastkyciriuyitrpetrtsy/${t}/${n}`
      })(),
      n = document.createElement("script");
    n.setAttribute("src", t), n.setAttribute("type", "text/javascript"), n.setAttribute("crossOrigin", "anonymous"), n.onload=n.onerror=()=>s.dequeue(), document.head.appendChild(n)
  }
})();
