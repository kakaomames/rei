...
public abstract class amk<T> implements DynamicOps<T> {
   protected final DynamicOps<T> a;

   protected amk(DynamicOps<T> $$0) {
      this.a = $$0;
   }
   ...
   public T emptyMap() {
      return this.a.emptyMap();
   }

   public T emptyList() {
      return this.a.emptyList();
   }

   public <U> U convertTo(DynamicOps<U> $$0, T $$1) {
      return Objects.equals($$0, this.a) ? $$1 : this.a.convertTo($$0, $$1);
   }
   ...
   public ListBuilder<T> listBuilder() {
      return new amk.a(this.a.listBuilder());
   }

   public RecordBuilder<T> mapBuilder() {
      return new amk.b(this.a.mapBuilder());
   }

   protected class a implements ListBuilder<T> {
      private final ListBuilder<T> b;

      protected a(final ListBuilder<T> param2) {
         this.b = $$1;
      }
      ...
      public <E> ListBuilder<T> addAll(Iterable<E> $$0, Encoder<E> $$1) {
         $$0.forEach(($$1x) -> {
            this.b.add($$1.encode($$1x, this.ops(), this.ops().empty()));
         });
         return this;
      }
   ...
   protected class b implements RecordBuilder<T> {
      ...
      protected b(final RecordBuilder<T> param2) {
         this.b = $$1;
      }
