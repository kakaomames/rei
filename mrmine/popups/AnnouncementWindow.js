        ...
        this.imageContainer.render = function ()
        {
            ...
            if(root.announcementImage)
            {
                ...
                var imageBox = drawImageFitInBox(
                    ...
                    coords.y + borderWidth,
                    this.boundingBox.width - (borderWidth * 2),
                    this.boundingBox.height - (borderWidth * 2)
                );

                root.drawBox(
                    imageBox.x - borderWidth,
                    imageBox.y - borderWidth,
                    imageBox.width + (borderWidth * 2),
                    imageBox.height + (borderWidth * 2),
                    borderWidth,
                    0
                );
